...
> Open any archive. Instantly.

**Utilities / File Manager** built with Kotlin and modern Android development standards.
...
- **Core Functionality**: Streamlined tools and workflows for ZipMaster.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/hsinidev/ZipMaster.git
   cd ZipMaster
   ```
